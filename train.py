...
def build_dataset(config):
    ...
    dsTrain = ImageFolder('data/WildFirev4/train/', train_transforms, target_transform=target_transform)
    dsVal = ImageFolder('data/WildFirev4/test/', val_transforms, target_transform=target_transform)
